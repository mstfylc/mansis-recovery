...
const colors = {
  ...
  shadows: {
    success:
      '0px 1px 4px rgba(68, 214, 0, 0.25), 0px 3px 12px 2px rgba(68, 214, 0.35)',
    error:
    ...
    MuiDataGrid: {
      styleOverrides: {
        root: {
          border: 'none',
          '& .MuiDataGrid-cell': {
            borderBottom: `1px solid ${alpha(themeColors.black, 0.3)}`
          },
          '& .MuiDataGrid-columnHeaders': {
            borderBottom: `2px solid ${alpha(themeColors.black, 0.3)}`
          },
          '& .MuiDataGrid-footerContainer': {
            borderTop: `2px solid ${alpha(themeColors.black, 0.3)}`
          },
          '& .MuiDataGrid-row.Mui-selected': {
            backgroundColor: `${alpha(themeColors.primary, 0.1)} !important`,
            '&:hover': {
              backgroundColor: `${alpha(themeColors.primary, 0.2)} !important`
            }
          }
        }
      }
